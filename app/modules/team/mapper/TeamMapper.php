...
class TeamMapper extends BaseMapper
{
    public static function scheme(): array
    {
        return [
            ...
            Field::string()->withColumn("attend_email")->setProperty("attendEmail"),
            Field::string()->withColumn("excuse_email")->setProperty("excuseMail"),
            ...
            Field::string()->withColumn("app_version")->setProperty("appVersion"),
