...
class TeamPresenter extends SettingBasePresenter
{
    ...
    {
        return $this->formFactory->createStatusSetForm(fn(Form $form, $values): void => $this->statusFormSuccess($form, $values));
    }

    public function createComponentTeamConfigForm(): Form
    {
        return $this->formFactory->createTeamConfigForm(fn(Form $form, $values): void => $this->teamConfigFormSuccess($form, $values));
    }

    public function createComponentEventTypeForm(): Multiplier
    {
        return $this->formFactory->createEventTypeForm(fn(Form $form, $values): void => $this->eventTypeFormSuccess($form, $values));
    }
