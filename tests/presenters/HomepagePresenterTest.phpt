...
class HomepagePresenterTest extends IPresenterTest {
    ...
    function testActionDefault(){
        ...
        Assert::true($dom->has('div.container.homepage div.row div.col-md-7.my-3 div.card.sh-box div.card-header div.row div.col.col-md-auto button.btn.btn-sm.btn-light.btn-light-bordered i.fa.fa-sync'));
